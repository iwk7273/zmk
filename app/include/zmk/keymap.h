...
int zmk_keymap_get_layer_sensor_binding_at_idx(zmk_keymap_layer_id_t layer, uint16_t sensor_idx,
                                               struct zmk_behavior_binding *binding);
int zmk_keymap_set_layer_sensor_binding_at_idx(zmk_keymap_layer_id_t layer, uint16_t sensor_idx,
                                               const struct zmk_behavior_binding binding);
int zmk_keymap_get_layer_sensor_binding_param_at_idx(zmk_keymap_layer_id_t layer,
                                                     uint16_t sensor_idx,
                                                     enum zmk_keymap_sensor_binding_param param,
                                                     struct zmk_behavior_binding *binding);
int zmk_keymap_set_layer_sensor_binding_param_at_idx(zmk_keymap_layer_id_t layer,
                                                     uint16_t sensor_idx,
                                                     enum zmk_keymap_sensor_binding_param param,
                                                     const struct zmk_behavior_binding binding);
