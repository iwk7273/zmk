...
| `CONFIG_ZMK_STUDIO_RPC_THREAD_STACK_SIZE`               | int  | Stack size for the dedicated RPC thread. 8192 when user macro settings are enabled, 3072 on SAMD21, 1024 on STM32F072 | 4096    |
| `CONFIG_ZMK_STUDIO_RPC_NOTIFICATION_QUEUE_SIZE`         | int  | Number of notifications that can be deferred behind request responses. 1 on STM32F072                                 | 2       |
